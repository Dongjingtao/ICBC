...
import lich.test.annotation.injar.JarPeople;
...
public class ScanClassUtil {
	...
	public static List<Class<?>> getClasses(String packageName) {
		...
		try {
			//ClassLoader loader = JarPeople.class.getClassLoader();
			//URL url1=loader.getResource(packageDirName);
			//url1=loader.getResource("/lich/test/annotation/injar/JarPeople");
			//String filePath1 = URLDecoder.decode(url1.getFile(), "UTF-8");
							...
							if (name.startsWith(packageDirName)) {
								...
								if ((idx != -1) || recursive) {
									...
									if (name.endsWith(".class") && !entry.isDirectory()) {
										...
										try {
											// 添加到classes
											String nname=packageName + '.' + className;
											//System.out.println(nname);
											classes.add(Class.forName(nname));
